    ...
    const getData = () => {
        ...
        if(userData) {
            ...
            if(userData.expiration < currentTime || isRefreshing) {
                ...
                const params = {
                    'include': 'field_application_access,field_application_access.field_image,field_application_access.field_songs,field_application_access.field_songs.field_image,field_application_access.field_songs.field_full_song,field_favorites,field_favorites.field_image,field_favorites.field_full_song',
                    'fields[user--user]': 'id,field_application_access,display_name,center_message,field_favorites',
